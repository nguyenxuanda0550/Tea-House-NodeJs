...
function render(arr) {
    ...
    Array.from(arr).forEach(item => {
        $('.search-result').append(`
            <div class="owl_item col-lg-4 col-md-4 col-6 mt-5">
                            ...
                            <div class="box_price d-flex">
                                <div>
                                    <span class="special_price">
                                        <span id="" class="prices" style="color:#4d8a54;font-size: 20px;">${format(item.price)}</span>
                                    </span>
                                </div>
            
                                <div class="text-right w-100">
                                    <button data-id="${item._id}" style="background: #4d8a54; border: 1px solid #4d8a54" id="btn-same" type="submit" class="btn-same btn btn-primary">
                                        Thêm vào giỏ
                                    </button>
                                </div>
                            </div>
