...
$("#btn_pay").click(function () {
    $.ajax({
        ...
        Email.send({
            Host: "smtp.gmail.com",
            Username: "teahouse.covid19@gmail.com",
            Password: "Da123456",
            SecureToken: "424b416f-34f1-4aa5-b011-a7e5e91de931",
            From: "teahouse.covid19@gmail.com",
            To: email,
            Subject: "You've ordered from Tea House!",
            Body: bd
